...
public struct MapBuildingCell: ReducerProtocol {
    //MARK: - State
...
public struct MapBuildingCellView: View {
    ...
    public let store: StoreOf<MapBuildingCell>
    
    public init(store: StoreOf<MapBuildingCell>) {
        self.store = store
    }
...
//MARK: - MOCKS & PREVIEW
#if DEBUG
public extension MapBuildingCell.State {
